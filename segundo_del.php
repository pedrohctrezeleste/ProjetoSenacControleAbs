...
if (isset($_POST['excluir'])) {
    ...
    if ($quantidade <= 0) {
        ...
        header("Location: segundo_del.php");
        exit;
    ...
    $result_delete = "
        ...
        SET qt_segundo = qt_segundo - $quantidade

        WHERE qt_segundo >= $quantidade
    ...
    if (
        ...
        header("Location: segundo_del.php?erro=quantidade");
        exit;
            ...
            <div class="cabecalho-conteudo">
                ...
                <div>
                    ...
                    <p>
                        ...
                        Retirada de absorventes — Segundo andar
                    ...
                    <div class="card-controle text-center">
                        ...
                        ?>
                            ...
                            <div class="quantidade-atual">
                                ...
                                echo $row_quantidade['qt_segundo'];
