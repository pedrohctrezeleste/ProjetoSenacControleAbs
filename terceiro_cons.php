...
while($row_quantidade = mysqli_fetch_assoc($resultado)){
    ...
    if($row_quantidade['qt_terceiro'] !== NULL){
        ...
        echo "<td>: " . $row_quantidade['qt_terceiro'] . "</td>";
